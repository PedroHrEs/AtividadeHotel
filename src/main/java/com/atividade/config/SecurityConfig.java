...
import com.atividade.security.JWTAuthenticationFilter;
import com.atividade.security.JWTUtils;
...
public class SecurityConfig {
    ...
    public SecurityConfig(Environment env, JWTUtils jwtUtils, AtendenteDetailsServiceImpl atendenteDetailsService) {
        this.env = env;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(new JWTAuthenticationFilter(jwtUtils, atendenteDetailsService),
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.userDetailsService(atendenteDetailsService).passwordEncoder(passwordEncoder());
